"""Independent Agent-4 black-box audit of Agent-2's public-z pullback provider.

This module preserves the scientific protocol used by Agent 4 on PR #543 and
rerun unchanged on PR #553, while rebinding only the public candidate under test
to Agent 2 PR #561. The primary oracle consumes only ``velocity_osc(x,y,z,t)``
from the public-z-pullback module. Cartesian spatial derivatives are reconstructed
independently with a centered fourth-order stencil on held-out off-grid points;
no Agent-2 phase, complete-curl, mass, training-loss, pressure, forcing, or
derivative helper is used as a validation oracle.
...
SCHEMA = "kokuno-agent4-public-z-pullback-independent-audit-v1"
...
# Frozen before evaluating this candidate; identical to Agent 4 #543/#553.
GUARDS = {
...
def run_audit() -> dict[str, Any]:
    ...
    return {
        ...
        "seed": SEED,
        "protocol": {
            "primary_interface": "public-z-pullback module-level velocity_osc(x,y,z,t) only",
