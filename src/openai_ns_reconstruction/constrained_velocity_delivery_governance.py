...
def audit_velocity_delivery_contract(
    ...
    """Validate the machine-readable delivery/claim boundary against the repo.
    ...
    # The current project state is explicitly not any of these stronger claims.
    # A later intentional promotion must change this auditor and provide evidence,
    # rather than silently flipping a JSON boolean.
