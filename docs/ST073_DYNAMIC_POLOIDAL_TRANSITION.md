...
**Later whole-support result:** `ST073_VOLUME_GENERALIZATION.md` shows this local-fit candidate worsens the sampled full-volume maximum and L2. It must not be treated as the current accepted construction; the geometric measurements above describe this unaccepted diagnostic field.
