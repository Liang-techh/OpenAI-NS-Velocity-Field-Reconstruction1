...
import openai_ns_reconstruction.kokuno_a4_current_rf40_power_law_radial_force_independent_audit as mod
...
def _stress_receipt(z: float, r: np.ndarray) -> dict[str, object]:
    ...
    return {
        ...
        "parent_agent3_1028_source_blob": mod.STRESS_PARENT_AGENT3_1028_SOURCE_BLOB,
        "provenance": {
            "parent_agent3_head": mod.STRESS_PARENT_AGENT3_1028_HEAD,
            "agent2_composite_head": mod.AGENT2_1010_HEAD,
            "agent1_leading_head": mod.AGENT1_1005_HEAD,
        },
        "axial_e1": {
...
def _force_receipt(center: float, r: np.ndarray) -> dict[str, object]:
    out: dict[str, object] = {
        ...
        "parent_agent3_1037_source_blob": mod.STRESS_AGENT3_SOURCE_BLOB,
