...
from openai_ns_reconstruction import constrained_st052m_localized_taper_material_path as m
...
def test_frozen_source_and_truth_contract() -> None:
    assert m.TASK_ID == "CR-A9-060"
    assert m.BASE_MAIN_SHA == "f0193d66c9d92948b4820ebcb70263673995b324"
    assert m.AGENT7_PR == 544
    assert m.AGENT7_HEAD == "093c7171cd61c6bd439afa30b2da69598a02d182"
    assert m.AGENT7_TASK_ID == "CR003-ST052M-LOCALIZED-TAPER-080"
    ...
    assert m.AXIAL_WINDOW == (0.50, 0.82)
    ...
    assert m.UPSTREAM_AGENT7_RECEIPT["clean_localized_taper_capacity"] is True
