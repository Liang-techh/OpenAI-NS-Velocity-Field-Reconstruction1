...
import openai_ns_reconstruction.kokuno_a4_current_i2_radial_force_independent_audit as mod
...
def _stress_receipt(z: float, r: np.ndarray) -> dict[str, object]:
    ...
    return {
        ...
        "parent_agent3_1073_source_blob": mod.STRESS_PARENT_AGENT3_1073_SOURCE_BLOB,
        "provenance": {
            "parent_agent3_head": mod.STRESS_PARENT_AGENT3_1073_HEAD,
            "agent2_composite_head": mod.AGENT2_1071_HEAD,
            "agent1_leading_head": mod.AGENT1_1061_HEAD,
        },
        "axial_e1": {
...
def _force_receipt(center: float, r: np.ndarray) -> dict[str, object]:
    out: dict[str, object] = {
        ...
        "parent_agent3_1081_source_blob": mod.STRESS_AGENT3_SOURCE_BLOB,
...
def test_public_audit_signature_has_no_scientific_tuning_knobs() -> None:
    ...
    assert boundary["newer_i3_i4_identity_consumed"] is False
