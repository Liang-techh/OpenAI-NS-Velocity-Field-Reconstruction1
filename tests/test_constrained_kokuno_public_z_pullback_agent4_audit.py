...
from openai_ns_reconstruction.kokuno_public_z_pullback_agent4_audit import (
    AUDITED_AGENT2_HEAD,
    FD4_STEPS,
    GUARDS,
    PHASE_RESOLUTIONS,
    PREVIOUS_AGENT4_EXECUTION_HEAD,
    SEED,
    run_audit,
)
...
def test_protocol_identity_and_frozen_guards():
    assert AUDITED_AGENT2_HEAD == "732800ce4990464b49c8aa32d0dff4580f6684d4"
    assert PREVIOUS_AGENT4_EXECUTION_HEAD == "2a18a87db0ef8c6682f10fc5a6355c90b4168c7c"
    assert SEED == 9173241
