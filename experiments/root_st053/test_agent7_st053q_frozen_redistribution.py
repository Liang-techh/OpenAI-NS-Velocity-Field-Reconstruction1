...
import agent7_st053q_frozen_redistribution as screen


def test_preregistered_contract_is_frozen():
    assert screen.PREREG_ISSUE == 538
    assert screen.PARENT_ID == "ST053-Q"
    assert screen.PARENT_HEAD == "fe63ec7fa197faaa4ba4e51f24b1b439411e9014"
    assert screen.UPSTREAM_PARENT_ID == "ST052-M"
